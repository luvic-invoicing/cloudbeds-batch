...
@Component
public class CancelRequestedStrategy implements DocumentoFiscalStrategy {

    private static final Logger logger = LogManager.getLogger(CancelRequestedStrategy.class);
